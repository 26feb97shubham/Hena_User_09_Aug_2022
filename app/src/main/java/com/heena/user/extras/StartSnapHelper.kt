...
import com.heena.user.utils.Utility.spToPx
import java.lang.IllegalStateException


class StartSnapHelper(private val context: Context) : LinearSnapHelper() {
    ...
    private fun distanceToStart(targetView: View, helper: OrientationHelper?): Int {
        return helper!!.getDecoratedStart(targetView) - (helper.startAfterPadding + spToPx(
            8F,
            context
        ))
    }
